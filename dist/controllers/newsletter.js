...
exports.getNewsletter = void 0;
const newsletter_1 = __importDefault(require("../models/newsletter"));
const getNewsletter = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const newsletterData = req.body;
    const newsletter = new newsletter_1.default(newsletterData);
